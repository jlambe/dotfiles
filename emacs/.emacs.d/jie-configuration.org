...
** Setup load paths
Add the =~/.emacs.d/jl-lisp/= and =~/.emacs.d/jl-emacs/=
...
Setup user customizations to be saved and loaded from a separate file
instead of using the default init.el file:
...
Enable relatice line numbers in prog-mode:
...
#+begin_src elisp :tangle "jl-emacs/jl-emacs-dired.el"
  ;;; -*- lexical-binding: t -*-
...
Configuration related to command interpreters in Emacs: compile,
comint, processes, ...

#+begin_src elisp :tangle "jl-emacs/jl-emacs-comint.el"
...
#+begin_src emacs-lisp :tangle "jl-emacs/jl-emacs-editorconfig.el"
  ;;; -*- lexical-binding: t -*-
...
** Elisp
#+begin_src emacs-lisp :tangle "jl-emacs/jl-emacs-elisp.el"
  ;;; -*- lexical-binding: t -*-

  (provide 'jl-emacs-elisp)
#+end_src
...
#+begin_src emacs-lisp :tangle "jl-emacs/jl-emacs-yasnippet.el"
  ;;; -*- lexical-binding: t -*-
...
** Skeletons
*** Generic skeletons
#+begin_src emacs-lisp :tangle "jl-emacs/jl-emacs-skeletons-generic.el" :mkdirp yes
  ;;; -*- lexical-binding: t -*-
  (define-skeleton jl-skeleton-generic-lexical-binding
    "A generic skeleton to insert the lexical binding comment."
    nil
    ";;; -*- lexical-binding: t -*-"
    \n)

  (provide 'jl-emacs-skeletons-generic)
#+end_src
...
** Reading
#+begin_src emacs-lisp :tangle "jl-emacs/jl-emacs-reading.el"
  ;;; -*- lexical-binding: t -*-
